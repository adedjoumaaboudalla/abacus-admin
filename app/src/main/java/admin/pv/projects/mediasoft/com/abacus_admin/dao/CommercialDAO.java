...
import admin.pv.projects.mediasoft.com.abacus_admin.database.CommercialHelper;
...
public class CommercialDAO extends DAOBase implements Crud<Commercial>{
    ...
    public ArrayList<Commercial> getCommercialByPv(long id) {
        ArrayList<Commercial> commercials = new ArrayList<Commercial>();
        Commercial commercial = null ;

        String rqte = "select * from "+ CommercialHelper.TABLE_NAME + " where " + CommercialHelper.POINTVENTE_iD + " = " + id + " order by " +CommercialHelper.TABLE_KEY + " desc " ;
