...
public class MouvementDAO extends DAOBase implements Crud<Mouvement> {
    ...
    public long add(Mouvement mouvement) {
        ...
        Log.e("MOUV Date",formatter.format(mouvement.getCreated_at())) ;
        return l;
    }
    ...
    public ArrayList<Mouvement> getLastMouvOfProduit(long id,Date datefin) {
        ...
        Log.e("DEBUG","select * from "+MouvementHelper.TABLE_NAME + " Where " + MouvementHelper.PRODUIT_ID + " = " + id + " and "  + MouvementHelper.CREATED_AT +  " <= '" + formatter2.format(datefin) +  " 23:59:59' order by " + MouvementHelper.CREATED_AT + " desc") ;
        Cursor res =  mDb.rawQuery( "select * from "+MouvementHelper.TABLE_NAME + " Where " + MouvementHelper.PRODUIT_ID + " = " + id + " and "  + MouvementHelper.CREATED_AT +  " <= '" + formatter2.format(datefin) +  " 23:59:59' order by " + MouvementHelper.CREATED_AT + " desc", null);
        res.moveToFirst();
    ...
    public ArrayList<Mouvement> getManyByProductInterval(long id,Date datedebut,Date datefin) {
        ...
        Log.e("DEBUG","select * from "+MouvementHelper.TABLE_NAME + " Where " + MouvementHelper.PRODUIT_ID + " = " + id + " and "  + MouvementHelper.CREATED_AT +  " between '" + formatter2.format(datedebut) + " 00:00:00' and '" + formatter2.format(datefin) +  " 23:59:59' ") ;
        Cursor res =  mDb.rawQuery( "select * from "+MouvementHelper.TABLE_NAME + " Where " + MouvementHelper.PRODUIT_ID + " = " + id + " and "  + MouvementHelper.CREATED_AT +  " between '" + formatter2.format(datedebut) + " 00:00:00' and '" + formatter2.format(datefin) +  " 23:59:59' ", null);
        res.moveToFirst();
    ...
    public ArrayList<Mouvement> getManyByInterval(Date datedebut,Date datefin) {
        ...
        Log.e("DEBUG","select * from "+MouvementHelper.TABLE_NAME + " Where "  + MouvementHelper.CREATED_AT +  " between '" + formatter2.format(datedebut) + " 00:00:00' and '" + formatter2.format(datefin) +  " 23:59:59' " ) ;
        Cursor res =  mDb.rawQuery( "select * from "+MouvementHelper.TABLE_NAME + " Where "  + MouvementHelper.CREATED_AT +  " between '" + formatter2.format(datedebut) + " 00:00:00' and '" + formatter2.format(datefin) +  " 23:59:59' order by " + MouvementHelper.TABLE_KEY + " asc", null);
        res.moveToFirst();
    ...
    public ArrayList<Mouvement> getManyByProduit(long id, Date datedebut,Date datefin) {
        if (datedebut==null) datedebut=new Date("01/01/2015");
        if (datefin==null) datefin=new Date() ;
        ...
        Log.e("DEBUG","select * from "+MouvementHelper.TABLE_NAME + " Where "  + MouvementHelper.CREATED_AT +  " between '" + formatter2.format(datedebut) + " 00:00:00' and '" + formatter2.format(datefin) +  " 23:59:59' " ) ;
        Cursor res =  mDb.rawQuery( "select * from "+MouvementHelper.TABLE_NAME + " Where "  + MouvementHelper.PRODUIT_ID + " = " + id + " and " + MouvementHelper.CREATED_AT +  " between '" + formatter2.format(datedebut) + " 00:00:00' and '" + formatter2.format(datefin) +  " 23:59:59' order by " + MouvementHelper.TABLE_KEY + " asc", null);
        res.moveToFirst();
    ...
    public ArrayList<Mouvement> getNonSync() {
        ...
        Cursor res =  mDb.rawQuery( "select * from "+MouvementHelper.TABLE_NAME + " Where  " + MouvementHelper.ETAT + " < 2  ", null);
        res.moveToFirst();
    ...
    public int updateMany(Operation operation) {
        ...
        contentValues.put(MouvementHelper.OPERATION_ID, operation.getId_externe());
